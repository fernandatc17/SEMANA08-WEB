...
import ordenCompraRoutes from "./app/routes/ordencompra.routes.js";
import detalleOrdenRoutes from "./app/routes/detalleordencompra.routes.js";
...
const corsOptions = {
    origin: "https://semana08-web-front-1.onrender.com",
};
...
app.use("/api/detalles", detalleOrdenRoutes);
